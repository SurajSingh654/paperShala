...
const adminSchema = new mongoose.Schema(
  {
    ...
    category: {
      ...
      trim: true,
      enum: {
        values: ["Admin", "Student", "Admin", "OrganizationHead"],
        message: "Category should be: Admin,Student,OrganizationHead or Admin",
      },
    },
    // organizations: [
    //   {
...
adminSchema.methods.checkPasswordMatch = function (
  candidatePassword,
  userPassword
) {
...
adminSchema.methods.checkPasswordChangedAt = function (JWTTimeStamp) {
