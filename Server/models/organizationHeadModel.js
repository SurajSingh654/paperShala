...
const organizationHeadSchema = new mongoose.Schema(
  {
    // firstName: {
    //   type: String,
...
organizationHeadSchema.virtual("fullName").get(function () {
...
organizationHeadSchema.pre("save", function (next) {
  this.firstName =
...
organizationHeadSchema.pre("save", async function (next) {
...
organizationHeadSchema.pre(/^find/, function (next) {
...
organizationHeadSchema.pre("aggregate", function (next) {
...
organizationHeadSchema.methods.checkPasswordMatch = function (
  candidatePassword,
  userPassword
) {
...
organizationHeadSchema.methods.checkPasswordChangedAt = function (
  JWTTimeStamp
) {
...
organizationHeadSchema.methods.createPasswordResetToken = function () {
...
const OrganizationHead = mongoose.model(
  "OrganizationHead",
  organizationHeadSchema
);

module.exports = OrganizationHead;
